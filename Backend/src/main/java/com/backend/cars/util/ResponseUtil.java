...
import com.backend.cars.constant.Constant;
import com.backend.cars.dto.response.PageDto;
...
public class ResponseUtil {
    ...
    public ResponseEntity<ResponseDto> getConflictResponse(Map<String, List<String>> error) {
        return new ResponseEntity<>(new ResponseDto(error, HttpStatus.CONFLICT.getReasonPhrase(), HttpStatus.CONFLICT.value()), HttpStatus.CONFLICT);
    }
